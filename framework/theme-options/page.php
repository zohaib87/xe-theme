...
Redux::setSection( 'xe_options', array(
    ...
    'fields'     => array(
        ...
        array( 
            ...
            'output'   => array( '.page '.wp_kses_data($xe_opt->selectors['bg-color']) ),
            'mode'     => 'background',
        ),
        ...
        array(
            ...
            'validate' => 'color',
            'output'    => array(
                'color' => '.page '.wp_kses_data($xe_opt->selectors['title-color'])
            )
        ),
        ...
        array(
            ...
            'validate' => 'color',
            'output'    => array(
                'color' => '.page '.wp_kses_data($xe_opt->selectors['subtitle-color'])
            )
        ),

        array(         
            'id'       => 'page_title_bar_bg',
            'type'     => 'background',
            ...
            'output'   => array( '.page '.wp_kses_data($xe_opt->selectors['title-bar-bg']) )
        ),

        array( 
            'id'       => 'page_title_bar_overlay',
            'type'     => 'color_rgba',
            ...
            'output'   => array( '.page '.wp_kses_data($xe_opt->selectors['title-bar-overlay']) ),
            'mode'     => 'background',
        ),
        ...
        array(
            'id'       => 'page_right_sidebar_selector',
            'type'     => 'select',
