...
Redux::setSection( 'xe_options', array(
    ...
    'desc'       => esc_html__( 'Events Archive Page.', '_xe' ),
    'subsection' => true,
    'fields'     => array(

        array(
            'id'       => 'events_list_tool_bar',
            'type'     => 'select',
        ...
        array(
            'id'       => 'events_list_header_location',
            'type'     => 'select',
        ...
        array( 
            ...
            'output'   => array( '.archive.post-type-archive-xe-events '.wp_kses_data($xe_opt->selectors['bg-color']) ),
            'mode'     => 'background',
        ),

        array(
            'id'       => 'events_list_title_bar',
            'type'     => 'switch',
        ...
        array(
            ...
            'validate' => 'color',
            'output'    => array(
                'color' => '.archive.post-type-archive-xe-events '.wp_kses_data($xe_opt->selectors['title-color'])
            )
        ),

        array(
            'id'       => 'events_list_subtitle_color',
            'type'     => 'color',
            ...
            'validate' => 'color',
            'output'    => array(
                'color' => '.archive.post-type-archive-xe-events '.wp_kses_data($xe_opt->selectors['subtitle-color'])
            )
        ),

        array(         
            'id'       => 'events_list_title_bar_bg',
            'type'     => 'background',
            ...
            'output'   => array( '.archive.post-type-archive-xe-events '.wp_kses_data($xe_opt->selectors['title-bar-bg']) )
        ),

        array( 
            'id'       => 'events_list_title_bar_overlay',
            'type'     => 'color_rgba',
            ...
            'output'   => array( '.archive.post-type-archive-xe-events '.wp_kses_data($xe_opt->selectors['title-bar-overlay']) ),
            'mode'     => 'background',
        ),

        array(
            'id'       => 'events_list_title_bar_height',
            'type'     => 'text',
        ...
        array(
            'id'       => 'events_list_sidebar_position',
            'type'     => 'select',
        ...
        array(
            'id'       => 'events_list_left_sidebar_selector',
            'type'     => 'select',
        ...
        array(
            'id'       => 'events_list_right_sidebar_selector',
            'type'     => 'select',
        ...
        array(
            'id'       => 'events_list_slug',
            'type'     => 'text',
            'title'    => esc_html__('Events Slug', '_xe'),
            'subtitle' => esc_html__('', '_xe'),
            'desc'     => esc_html__('', '_xe'),
            'default'  => 'events'
        ),
