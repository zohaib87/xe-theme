<?php 
/**
 * Portfolio Single Theme Options.
 *
 * @package _xe
 */
...
Redux::setSection( 'xe_options', array(
    ...
    'id'         => 'opt_portfolio_single',
    'title'      => esc_html__( 'Single', '_xe' ),
    'desc'       => esc_html__( 'Single Portfolio Page.', '_xe' ),
    'subsection' => true,
    'fields'     => array(

        array(
            'id'       => 'portfolio_header_menu',
            'type'     => 'select',
        ...
        array( 
            ...
            'output'   => array( '.single-xe-portfolio '.wp_kses_data($xe_opt->selectors['bg-color']) ),
            'mode'     => 'background',
        ),

        array(
            'id'       => 'portfolio_title_bar',
            'type'     => 'switch',
        ...
        array(
            ...
            'validate' => 'color',
            'output'    => array(
                'color' => '.single-xe-portfolio '.wp_kses_data($xe_opt->selectors['title-color'])
            )
        ),
        ...
        array(
            ...
            'validate' => 'color',
            'output'    => array(
                'color' => '.single-xe-portfolio '.wp_kses_data($xe_opt->selectors['subtitle-color'])
            )
        ),

        array(         
            'id'       => 'portfolio_title_bar_bg',
            'type'     => 'background',
            ...
            'output'   => array( '.single-xe-portfolio '.wp_kses_data($xe_opt->selectors['title-bar-bg']) )
        ),

        array( 
            'id'       => 'portfolio_title_bar_overlay',
            'type'     => 'color_rgba',
            ...
            'output'   => array( '.single-xe-portfolio '.wp_kses_data($xe_opt->selectors['title-bar-overlay']) ),
            'mode'     => 'background',
        ),

        array(
            'id'       => 'portfolio_title_bar_height',
            'type'     => 'text',
        ...
        array(
            'id'       => 'portfolio_left_sidebar_selector',
            'type'     => 'select',
        ...
        array(
            'id'       => 'portfolio_right_sidebar_selector',
            'type'     => 'select',
        ...
        array(
            'id'       => 'related_portfolios',
            'type'     => 'switch',
            'title'    => esc_html__('Related Portfolios', '_xe'),
            'subtitle' => esc_html__('', '_xe'), 
            'desc'     => esc_html__('Enable to show related portfolios.', '_xe'),
            'on' => 'Enable',
            'off' => 'Disable',
            'default'  => true
        ),
